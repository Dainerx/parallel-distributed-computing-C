...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  if (equal_mats(ci.lines_a, ci.columns_b, mat_C_Seq, mat_C_Other) == false)
  {
    printf("Multiplication en parallèle version naive has produced a wrong result.\n");
  }
  ...
  if (equal_mats(ci.lines_a, ci.columns_b, mat_C_Seq, mat_C_Other) == false)
  {
    printf("Multiplication en parallèle version optimisée has produced a wrong result.\n");
  }
